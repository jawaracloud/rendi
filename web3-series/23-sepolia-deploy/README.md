# 23 — Deploying to Sepolia Testnet

> **Type:** Tutorial | **Language Focus:** Solidity/Forge

## Objective

Deploy to a public testnet using infura/alchemy RPCs.
...
| Concept | Description |
|---------|-------------|
| Solidity/Forge | Primary language/tool used in this lesson. |
